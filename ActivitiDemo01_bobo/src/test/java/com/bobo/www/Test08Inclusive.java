...
public class Test08Inclusive {
    ...
    public void test01() {
        ...
        Deployment deploy = repositoryService.createDeployment()
                .addClasspathResource("activiti/evection-Parallel.bpmn20.xml")
                .addClasspathResource("activiti/evection-parallel.png")
                .name("出差申请单-并行网关")
                .deploy();
